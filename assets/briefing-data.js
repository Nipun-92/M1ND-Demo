...
const BRIEFING_DATA = {
  ...
  lawyer: {
    ...
    judge_affinity: [
      { judge:"Judge C", cases:330 },
      { judge:"Judge D", cases:281 },
      { judge:"Judge E", cases:227 }
    ],
    outcomes: [
    ...
    // Rhetorical Role breakdown (real from rhetorical_role_sentences for lawyer_id=<illustrative>)
    rr_total: 70490,
    rr: {
    ...
    opp_name: "Counsel B", opp_apps: 2254
  },
